...
var usersTokensRepositoryInMemtory;
var dateProvider;
var createUserUseCase;
describe("Authenticate User", function () {
    beforeEach(function () {
        usersRepositoryInMemory = new UsersRepositoryInMemory_1.UsersRepositoryInMemory();
        usersTokensRepositoryInMemtory = new UsersTokensRepositoryInMemory_1.UsersTokensRepositoryInMemory();
        dateProvider = new DayjsDateProvider_1.DayjsDateProvider();
        authenticateUserUsecase = new AuthenticateUserUseCase_1.AuthenticateUserUseCase(usersRepositoryInMemory, usersTokensRepositoryInMemtory, dateProvider);
