...
var ResetPasswordUseCase = /** @class */ (function () {
    function ResetPasswordUseCase(usersTokensRepository, dateProvider, usersRepository) {
        this.usersTokensRepository = usersTokensRepository;
        this.dateProvider = dateProvider;
        this.usersRepository = usersRepository;
    }
    ResetPasswordUseCase.prototype.execute = function (_a) {
