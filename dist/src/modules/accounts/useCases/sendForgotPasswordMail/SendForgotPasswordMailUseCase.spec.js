...
var AppError_1 = require("../../../../shared/infra/http/errors/AppError");
...
describe("Send Forgot Mail", function () {
    beforeEach(function () {
        ...
        sendForgotPasswordMailUseCase = new SendForgotPasswordMailUseCase_1.SendForgotPasswordMailUseCase(usersRepositoryInMemory, usersTokensRepositoryInMemory, dateProvider, mailProviderInMemory);
    });
    it("should be able to send a forgot password mail to user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotPasswordMailUseCase.execute("rukdu@vezwo.tn")];
                case 2:
                    _a.sent();
    ...
    it("should not be able to send an email if user does not exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgotPasswordMailUseCase.execute("dejop@ijoditgew.my")).rejects.toEqual(new AppError_1.AppError("User does not exists!"))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sendForgotPasswordMailUseCase.execute("vow@akrob.no")];
                case 1:
                    _a.sent();
