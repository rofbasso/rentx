...
var SendForgotPasswordMailUseCase = /** @class */ (function () {
    function SendForgotPasswordMailUseCase(usersRepositoy, usersTokensRepository, dateProvider, mailProvider) {
        this.usersRepositoy = usersRepositoy;
    ...
    SendForgotPasswordMailUseCase.prototype.execute = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersRepositoy.findByEmail(email)];
                    case 1:
                        user = _a.sent();
