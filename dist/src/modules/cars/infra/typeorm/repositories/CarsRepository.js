...
var CarsRepository = /** @class */ (function () {
    ...
    CarsRepository.prototype.create = function (_a) {
        var brand = _a.brand, category_id = _a.category_id, daily_rate = _a.daily_rate, license_plate = _a.license_plate, description = _a.description, fine_amount = _a.fine_amount, name = _a.name, specifications = _a.specifications, id = _a.id;
