...
var SpecificationsRepositoryInMemory_1 = require("../../repositories/in-memory/SpecificationsRepositoryInMemory");
...
describe("Create Car Specification", function () {
    ...
    it("should be able to add a new specification to the car", function () { return __awaiter(void 0, void 0, void 0, function () {
        var car, specification, specifications_id, specitificationsCars;
        return __generator(this, function (_a) {
            switch (_a.label) {
