...
var uploadCarImage = (0, multer_1.default)(upload_1.default);
...
var upladoCarImagesController = new UploadCarImagesController_1.UploadCarImagesController();
...
carsRoutes.post("/images/:id", ensureAuthenticated_1.ensureAuthenticated, ensureAdmin_1.ensureAdmin, uploadCarImage.array("images"), upladoCarImagesController.handle);
