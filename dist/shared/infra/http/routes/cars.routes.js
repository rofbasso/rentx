...
const upladoCarImagesController = new _UploadCarImagesController.UploadCarImagesController();
...
carsRoutes.post("/images/:id", _ensureAuthenticated.ensureAuthenticated, _ensureAdmin.ensureAdmin, uploadCarImage.array("images"), upladoCarImagesController.handle);